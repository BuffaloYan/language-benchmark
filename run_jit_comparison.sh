...
echo "[JIT] JavaScript JIT Compilation Comparison"
echo "============================================"
echo
...
if ! command -v node &> /dev/null; then
    echo "[ERROR] Node.js not found. Please install Node.js to run this comparison."
    exit 1
fi

echo "[DATA] Test Data: 10,000,000 integers"
echo

# Test 1: With JIT (default)
echo "[JIT-ON] Test 1: WITH JIT Optimization (Default V8)"
echo "=============================================="
...
echo "[JIT-OFF] Test 2: WITHOUT JIT Optimization"
echo "==========================================="
...
echo "[INTERPRETED] Test 3: INTERPRETED ONLY"
echo "======================================="
